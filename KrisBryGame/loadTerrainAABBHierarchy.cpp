// TODO: Update to use new structures in Ply floder
...
//
//		curAABBTri.verts[0] = converVertsToWorld(curAABBTri.verts[0], transformComp->position, transformComp->orientation);
//		curAABBTri.verts[1] = converVertsToWorld(curAABBTri.verts[1], transformComp->position, transformComp->orientation);
//		curAABBTri.verts[2] = converVertsToWorld(curAABBTri.verts[2], transformComp->position, transformComp->orientation);
//
//		//normals
...
//
//	for (unsigned int i = 0; i != g_AABBTerrianHierarchy.staticEntities.size(); ++i) {
//		loadTerrainIntoTerrainAABBHierarchy(g_AABBTerrianHierarchy.staticEntities[i]);
//	}
//
