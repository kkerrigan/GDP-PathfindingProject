...
bool cShaderManager::cShaderProgram::LoadAtrributeLocation(std::string variableName) {

	GLint attribLocation = glGetAttribLocation(this->ID, variableName.c_str());
	...
	this->mapUniformName_to_UniformLocation[variableName.c_str()] = attribLocation;
