// TODO: Fix Physics because of ASSIMP changes
#include "cPhysics.h"
...
bool cPhysics::areSpheresPenetrating(cEntity* entity1, cEntity* entity2) {
	...
	cTransformComponent* pObj1Transform = entity1->getComponent<cTransformComponent>();
	cEulerMovementComponent* pObjec1EulerMovement = entity1->getComponent<cEulerMovementComponent>();
	cCollider* pObj1Collider = entity1->getComponent<cCollider>();

	cTransformComponent* pObj2Transform = entity2->getComponent<cTransformComponent>();
	cEulerMovementComponent* pObjec2EulerMovement = entity2->getComponent <cEulerMovementComponent>();
	cCollider* pObj2Collider = entity2->getComponent<cCollider>();
...
bool cPhysics::testSphereAABB(cEntity* s, cEntity* b, glm::vec3 &p) {
	...
	cTransformComponent* pObj1Transform = s->getComponent<cTransformComponent>();
	cEulerMovementComponent* pObjec1EulerMovement = s->getComponent<cEulerMovementComponent>();
	cCollider* pObj1Collider = s->getComponent<cCollider>();

	cTransformComponent* pObj2Transform = b->getComponent<cTransformComponent>();
	cEulerMovementComponent* pObjec2EulerMovement = b->getComponent<cEulerMovementComponent>();
	cCollider* pObj2Collider = b->getComponent<cCollider>();
