...
cFlyCamera::cFlyCamera() {
	...
	this->minFollowDistance = 50.0f;
	this->cameraMoveSpeed = 40.0f;

	// This will be constant
	this->m_frontOfCamera = FORWARD;
	this->m_upIsYVector = UP;
...
void cFlyCamera::followSelectedEntity(float deltaTime, cEntity* pEntity) {
