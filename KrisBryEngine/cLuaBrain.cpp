...
int fireCannons(lua_State* luaState); // For final Q7
...
cLuaBrain::cLuaBrain() {
	...
	lua_pushcfunction(this->m_luaState, orientCameraToEntity);
	lua_setglobal(this->m_luaState, "orientCameraToEntity");

	lua_pushcfunction(this->m_luaState, wait);
	lua_setglobal(this->m_luaState, "wait");
	
	lua_pushcfunction(this->m_luaState, orientToEntityDistance);
	lua_setglobal(this->m_luaState, "orientToEntityDistance");

	lua_pushcfunction(this->m_luaState, fireCannons);
	lua_setglobal(this->m_luaState, "fireCannons");
